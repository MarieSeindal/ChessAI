...
public class newAI {
        ...
        public newAI(Board currentBoard, boolean isWhite) {
        ...
        public void fillChildren(ChessNode parent, boolean white) {
            ...
            ArrayList<Move> tempListOfMoves = new ArrayList<Move>();
                ...
                for (char piece : row) {
                    ...
                    if (piece != ' ') {
                        ...
                        if (white && Character.isUpperCase(piece)) { //If it's the current player, and It's that players pieces.
                            ...
                            tempListOfMoves = Game.allMovesFromPiece(piece, coords, currentBoard, true);

                            // we don't add anything to the parent, if there is no moves to make
                            if (tempListOfMoves.size() >= 1) {

                                ChessNode copy = new ChessNode(tempListOfMoves);
                                copy.setBoard(parent.board);
...
//                            }
                            ...
                            //Get possible moves for that piece
                            int[] coords = {rows, column};
                            tempListOfMoves = Game.allMovesFromPiece(piece, coords, currentBoard, false);
